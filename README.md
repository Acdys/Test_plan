...
*Ожидаемый результат:* после ввода валидных данных форма отправки выполнена успешна, запись на курс произведена
...
2. **Заполнение формы "Запишитесь на курс" валидными данных поля "Имя"** (русские и латинские буквы; не меньше 2 и не больше 30 букв; букву *ё*; строчные и заглавные буквы; дефис) > *успешное заполнение*.
3. **Заполнение формы "Запишитесь на курс" валидными данных поля "+7 (999) 999-99-99"** (11 цифр; начало номера с *" +7 "* или *8*) > *успешное заполнение*.
4. **Заполнение формы "Запишитесь на курс" валидными данных поля "Электронная почта"** (локальная часть адреса, разделенная " @ " с доменной частью имени с точкой) > *успешное заполнение*.
...
6.  **После заполнения формы нажать на кнопку "Записаться".
